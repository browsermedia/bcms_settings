SPEC = Gem::Specification.new do |spec| 
  spec.name = "bcms_settings"
  spec.rubyforge_project = spec.name
  spec.version = "1.0.0"
  spec.summary = "A Settings Module for BrowserCMS"
  ...
  spec.files += Dir["lib/bcms_settings.rb"]
  spec.files += Dir["lib/bcms_settings/*"]
  spec.files += Dir["rails/init.rb"]
  spec.files += Dir["public/bcms/settings/**/*"]
  spec.has_rdoc = true
